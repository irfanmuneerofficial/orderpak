...
class BannerFourController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $bannerfour = HomeBannerFour::get();
        return view('admin.home.bannerfour.index')
        ->with(compact('categories','bannerfour'));
    }
