...
class BannerThreeController extends Controller
{
    ...
    public function index()
    {
        ...
        $bannerthree = HomeBannerThree::get();
        return view('admin.home.bannerthree.index')
        ->with(compact('categories','bannerthree'));
    }
