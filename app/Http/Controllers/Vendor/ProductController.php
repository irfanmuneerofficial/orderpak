...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        ->with(compact('category','brands','colors','sizes','parentcategory','childcategory'));
    }
...
//-----------------------------------
            ...
            if(!empty($skuArr) && $skuArr[0]!=null)
            {
                foreach($skuArr as $key=>$val)
                {
                    ...
                    if(isset($attr_sale_dateArr[$key]))
                    {
                        ...
                        $productAttrArr['attr_sale_start']=NULL;
                        $productAttrArr['attr_sale_end']=NULL;      
                    }					
    ...
    public function destroy($id)
    {
        ...
        return back()->with('success', 'Your product has been deleted!');
    }
    */
    public function destroy($id)
    {
...
*/
    ...
    //16March2022 Product Attributes
