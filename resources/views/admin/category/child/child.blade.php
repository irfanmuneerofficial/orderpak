          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-success py-0" style="font-size: 0.8em; width:100px;" id="createNewCompany" href='{{route('childcategory.create')}}'>Create Sub Category</a>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td data-id="{{$category->id}}">
                        <a class="btn btn-default btn-sm" href="/admin/childcategory/{{ $category->id }}/edit"><i class="fa fa-edit"></i></a>
