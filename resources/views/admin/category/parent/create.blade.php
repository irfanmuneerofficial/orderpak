...
@section('mainContent')
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      @endif
      <form name="form-example-1" id="form-example-1" action="{{route('subcategory.store')}}/" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <button type="submit" class="btn btn-success float-right">Add SubCategory</button>
          </div>
        </div>
    </section>
  </div>
