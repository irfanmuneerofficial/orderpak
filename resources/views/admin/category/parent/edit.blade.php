...
@section('mainContent')
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      @endif
      <form name="form-example-1" id="form-example-1" action="/admin/subcategory/{{$subcategory->id}}/" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
          <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <select name="main_id" id="category_id" class="form-control" required="required">
                          <option value="{{$subcategory->main_id}}">{{$subcategory->main_id}}</option>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <button type="submit" class="btn btn-success float-right">Edit SubCategory</button>
          </div>
        </div>
    </section>
  </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $.ajax({
        url: '/admin/view_subcategory/?id='+id+'/',
        type: 'GET',
        format: 'json',
