...
<section class="content">
  ...
  @endif
  <form name="form-example-1" id="form-example-1" action="{{route('commission.store')}}/" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="form-group">
	                    ...
	                    <input type="text" id="main_rate" name="main_rate" class="form-control" id="exampleInputEmail1" placeholder="Example: 20%">
	                  </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group" id="parentselect" style="display:none;">
                    ...
                    <div class="form-group">
	                    ...
	                    <input type="text" id="parent_rate" name="parent_rate" class="form-control" id="exampleInputEmail1" placeholder="Example: 20%">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group" id="childselect" style="display:none;">
                    ...
                    <div class="form-group">
	                    ...
	                    <input type="text" id="child_rate" name="child_rate" class="form-control" id="exampleInputEmail1" placeholder="Example: 20%">
                    </div>
                  </div>
                </div>
              </div>
...
<div class="row">
  <div class="col-12">
    ...
    <button type="submit" class="btn btn-success float-right">Add Commission</button>
  </div>
</div>
</section>
</div>
