...
@endsection
@section('mainContent')
<link href="{{ asset('admin/assets') }}/css/treeview.css" rel="stylesheet">
    ...
    <section class="content">
      ...
      <div class="container-fluid">     
        <div class="card card-primary">
          <div class="card-header">Commission List</div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                      ...
                      @foreach($categories as $category)
                          <li>
                            @if($category->commission)
                                {{ $category->title }} {{ $category->commission->rate }}
                            @else
                                {{ $category->title }}
                            @endif
                              
                            @if(count($category->childCategories))
                              @include('admin.partials.commission.manageChild',['childs' => $category->childCategories])
                            @endif
                          </li>
                      @endforeach
                  </ul>
...
@push('ajax_crud')
<script src="{{ asset('admin/assets') }}/js/treeview.js"></script>
