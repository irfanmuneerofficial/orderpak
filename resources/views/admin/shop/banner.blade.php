...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Shop Banner</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form role="form" method="post" action="/admin/shop_banner/" enctype="multipart/form-data">
                          @csrf
                          <div class="card-body">
              ...
              <div class="table-responsive">
                <table id="example1" class="table table-hover table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$id++}}</td>
                      <td><img src="/uploads/shop/{{$row->banner_img}}" width="50" alt=""></td>
                      <td>{{$row->link}}</td>
                      <td>
                        ...
                        <div class="modal fade" id="modal-{{$row->id}}">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form role="form" id="updateform" action="/admin/shop_banner/?id={{$row->id}}/" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="card-body">
                                          <div class="form-group">
                        ...
                        <form method="post" action="/admin/shop_banner/?id={{$row->id}}/">
                        {{ csrf_field() }}
                        {{ method_field('delete') }}
