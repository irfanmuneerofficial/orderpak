                ...
                <form action="{{ url('vendor/payout') }}/" enctype="multipart/form-data" class="form" method="POST" role="form">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<input type="text" name="account_title" class="form-control" id="" placeholder="Input field">
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<input type="number" name="account_no" class="form-control" id="" placeholder="Input field">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<input type="number" name="branch_code" class="form-control" id="" placeholder="Input field">
						</div>
					</div>
