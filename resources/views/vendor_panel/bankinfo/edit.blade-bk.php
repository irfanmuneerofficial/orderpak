                ...
                <form action="{{ url('/vendor/payout/' + $data->id ) }}/" enctype="multipart/form-data" class="form" method="POST" role="form">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<input type="text" name="account_title" value="{{$data->account_title}}" class="form-control" id="" placeholder="Input field">
						</div>
					</div>
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<input type="number" name="account_no" value="{{$data->account_no}}" class="form-control" id="" placeholder="Input field">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12">
							<label for="">Bank Name</label>
							<input type="text" name="bank_name" value="{{$data->bank_name}}" class="form-control" id="" placeholder="Input field">
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12">
