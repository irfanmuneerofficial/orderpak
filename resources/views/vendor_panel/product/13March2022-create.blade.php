                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                          ...
                          <div class="col-md-1">
                              ...
                              <input id="sku" name="sku[]" type="text" class="form-control" aria-required="true" autocomplete="off" aria-invalid="false">
                          </div>
                          <div class="col-md-1">
...
var loop_count=1; 
  function add_more(){
    // $(this).select2();
      ...
      html+='<div class="col-md-1"><select id="color_id'+loop_count+'" name="color_id[]" class="form-control select2bs4" style="width: 100%;">'+color_id_html+'</select></div>';
      ...
      html+='<div class="col-md-1"><input id="sku" autocomplete="off" name="sku[]" type="text" class="form-control" aria-required="true" aria-invalid="false"></div>'; 
      html+='<div class="col-md-1"><input id="attr_price'+loop_count+'" name="attr_price[]" maxlength="5" pattern=".{1,5}" onkeypress="return isNumber(event)" autocomplete="off" type="text" class="form-control" aria-required="true" aria-invalid="false"></div>';
      ...
      html+='<div class="col-md-1"><input id="qty" name="qty[]" autocomplete="off" type="text" class="form-control attr_qty" maxlength="4" pattern=".{1,5}" onkeypress="return isNumber(event)"  aria-required="true" aria-invalid="false"></div>';
      html+='<div class="col-md-2"><input id="attr_image" name="attr_image[]" type="file" class="form-control" aria-required="true" aria-invalid="false"></div>';
