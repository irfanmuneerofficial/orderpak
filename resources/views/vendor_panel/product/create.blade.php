          ...
          <div class="card-body">
            ...
            <div class="form-group required" id="short_descriptionErrDiv">
              ...
              <div class="mb-3">
                ...
                style="width: 100%; height: 80px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
              </div>
            </div>
                  ...
                  <div > 
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            ...
                            <select  id="color_id" name="color_id[]" class="form-control select2bs4" style="width: 100%;">
                          ...
                          <div class="col-md-1">
                              ...
                              <input id="attr_sku" name="sku[]" type="text" class="form-control" aria-required="true" autocomplete="off" aria-invalid="false">
                              <span class="text-danger" id="attr_skuErr"></span>
                          </div>
                          <div class="col-md-1">
                              <!-- <label for="price" class="control-label mt-0"> Price</label> -->
                              <input id="attr_price" name="attr_price[]"  maxlength="5" pattern=".{1,5}" onkeypress="return isNumber(event)" autocomplete="off" type="text" class="form-control" aria-required="true" aria-invalid="false">
                                <span class="text-danger" id="attr_priceErr"></span>
                          </div>
                          <div class="col-md-1">
                              <!-- <label for="price" class="control-label mt-0"> Price</label> -->
                              <input id="attr_sale_price" name="attr_sale_price[]"  maxlength="5" pattern=".{1,5}" onkeypress="return isNumber(event)" autocomplete="off"  type="text" class="form-control attr_sale_price" aria-required="true" aria-invalid="false">
                          ...
                          <div class="col-md-2" id="saledatetime">
                              ...
                              <input id="attr_sale_date" name="attr_sale_date[]" readonly type="text" class="form-control attr-datepicker" aria-required="true" aria-invalid="false">
                              <span class="text-danger" id="attrsaledateErr"></span>
                          </div>
                          <div class="col-md-1">
                              <!-- <label for="qty" class="control-label mt-0"> Qty</label> -->
                              <input id="qty" name="qty[]"  maxlength="4" pattern=".{1,4}" onkeypress="return isNumber(event)" autocomplete="off"  type="text" class="form-control attr_qty" aria-required="true" aria-invalid="false">
                              <span class="text-danger" id="qtyErr"></span>
                          </div>
                          <div class="col-md-2">
                              <!-- <label for="attr_image" class="control-label mt-0"> Image</label> -->
                              <input id="attr_image" name="attr_image[]" type="file" accept="image/*" class="form-control" aria-required="true" aria-invalid="false">
...
$(function () {
    $("#upload").bind("click", function (e) {
      ...
      else
      {
        ...
        {
            //14march2022 $('#upload').attr('disabled',true);
        }
      }
...
*/
    ...
    if(($('#price').val() == 0) && ($('#quantity').val() == 0))
  {
            ...
            //------------------SALEPRICEANDDATE----------------------
            if( ($("#attr_sale_date").val() == '') )
            {
                if($("#attr_sale_price").val() != '')
                {
                  alert('Please Select Sale Date');
                  $('html, body').animate({
                  scrollTop: $("#attr_sale_date").offset().top
                  }, 2000);
            ...
            if($("#attr_sale_date").val() != '')
            {
              ...
              if( ($("#attr_sale_price").val() == '')|| ($("#attr_sale_price").val() == 0))
              {
                alert('Sale Price is required');
                $('html, body').animate({
                scrollTop: $("#attr_sale_price").offset().top
                }, 2000);
...
var loop_count=1; 
  function add_more(){
    // $(this).select2();
      ...
      html+='<div class="col-md-1"><span class="text-danger" id="color_id'+loop_count+'skuErr"></span><select id="color_id'+loop_count+'" name="color_id['+loop_count+']" class="form-control select2bs4" style="width: 100%;">'+color_id_html+'</select></div>';
      ...
      html+='<input id="attr_sku'+loop_count+'" name="sku['+loop_count+']" type="text" class="form-control" aria-required="true" aria-invalid="false">';
      html+='</div>'; 
      html+='<div class="col-md-1">';
      html+='<span class="text-danger" id="attr_price'+loop_count+'skuErr">';
      html+='<input id="attr_price'+loop_count+'"  name="attr_price['+loop_count+']" maxlength="5" pattern=".{1,5}" onkeypress="return isNumber(event)" autocomplete="off" type="text" class="form-control" aria-required="true" aria-invalid="false">';
      html+='</div>';
      html+='<div class="col-md-1"><input id="attr_sale_price'+loop_count+'" name="attr_sale_price['+loop_count+']" maxlength="5" pattern=".{1,5}" onchange="return isPriceSale('+loop_count+')" onkeypress="return isNumber(event)" autocomplete="off" type="text" class="form-control" aria-required="true" aria-invalid="false"></div>';
      html+='<div class="col-md-2"><input id="attr_sale_date'+loop_count+'" readonly name="attr_sale_date['+loop_count+']" type="text" class="form-control attr-datepicker" aria-required="true" aria-invalid="false"></div>';
      html+='<div class="col-md-1"><span class="text-danger" id="qty'+loop_count+'skuErr"><input id="qty'+loop_count+'" name="qty['+loop_count+']" type="text" class="form-control attr_qty" onkeypress="return isNumber(event)" maxlength="4" pattern=".{1,4}" aria-required="true" aria-invalid="false"></div>';
      html+='<div class="col-md-2"><span class="text-danger" id="attr_image'+loop_count+'skuErr"><input id="attr_image'+loop_count+'" name="attr_image['+loop_count+']" type="file" accept="image/*" class="form-control" aria-required="true" aria-invalid="false"></div>';
  ...
  $("#billtoship").click(function(){
    ...
    if(parseInt(attr_price) > parseInt(this.value))
    {
