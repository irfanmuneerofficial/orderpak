      ...
      <div class="col-md-12">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label>Sizes</label>
                  <select name="sizes" id="sizes" class="form-control select2bs4" style="width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="slug" name="slug" class="form-control" readonly="" type="text" placeholder="sku" class="required validate" required="">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>Color</label>
              <select class="select2" name="colors[]" id="colors" multiple="multiple" data-placeholder="Select a State" style="width: 100%;" required>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <div id="sale_off_button" class="btn btn-danger form-control off_saim">Sale Off</div>
                  <div id="sale_on_button" class="btn btn-info form-control on_saim">Sale On</div>
                </div>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                <div id="saledatetime" class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="sale_details" class="form-control float-right" value="" />
                    {{-- <input name="sale_details" type="text" class="form-control float-right" id="reservationtime"> --}}
                  </div>
                  <!-- /.input group -->
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <ul class="tags list-unstyled">
                <li class="tagAdd taglist">
                  <input type="text" name="tags[]" id="search-field">
                </li>
              </ul>
            </div>
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Select</label>
              <select name="warrenty_type" id="warrenty_type" class="form-control">
                <option value="company-warrenty">Company Warrenty</option>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="warrenty_period" id="warrenty_period" class="form-control">
